...
enum class IssuingBank(val bankName: String, val logo: Int, val color: Color) {
    ...
    NOT_SELECTED("", 0, Color(0xFF333333));

    companion object {
        fun getAllBanks(): List<IssuingBank> {
            return entries - NOT_SELECTED
        }
    }
}
